...
public class OI {
    ...
    public JoystickButton uncollect;
    ...
    public OI() {
        ...
        uncollect = new JoystickButton(operatorStick, 6);
        uncollect.whileHeld(new Purge());
        collect = new JoystickButton(operatorStick, 5);
        collect.whileHeld(new CollectorMoveRoller());
        ...
        findTargetBut = new JoystickButton(operatorStick, 9);
        ...
        autoLauchBut = new JoystickButton(operatorStick, 5);
        ...
        lowBarConfigurationButton = new JoystickButton(driverLeftStick, 4);
