...
public class OI {
    ...
    public JoystickButton launcherUnlockBut;
    ...
    public OI() {
        ...
        launcherPrimeBut.whileHeld(new LauncherPrime());
        launcherUnlockBut = new JoystickButton(operatorStick, 10);
        launcherUnlockBut.whenPressed(new LauncherUnlock());
        ...
        launcherReleaseBut = new JoystickButton(operatorStick, 7);
        launcherReleaseBut.whenPressed(new LauncherOpenClamp());
        ...
        switchOrientationBut.whenPressed(new DriveTrainSwitchOrientation());
        driverLeftStick = new Joystick(0);
        
        toggleCubic = new JoystickButton(driverLeftStick, 1);
        toggleCubic.whenPressed(new DriveTrainToggleCubic());
