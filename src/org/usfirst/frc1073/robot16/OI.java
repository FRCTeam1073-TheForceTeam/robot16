...
public class OI {
    ...
    public JoystickButton collectBoulderBut;
    public JoystickButton deployScissorLiftBut;
    public JoystickButton purgeBoulderBut;
    ...
    public OI() {
        ...
        purgeBoulderBut = new JoystickButton(operatorStick, 6);
        purgeBoulderBut.whileHeld(new Purge());
        deployScissorLiftBut = new JoystickButton(operatorStick, 3);
        deployScissorLiftBut.whenPressed(new DeployScissorLift());
        collectBoulderBut = new JoystickButton(operatorStick, 5);
        collectBoulderBut.whileHeld(new CollectorMoveRoller());
