...
public class OI {
    ...
    public JoystickButton driveTurboModeLeft;
    public Joystick driverLeftStick;
    public JoystickButton driveTurboModeRight;
    ...
    public OI() {
        ...
        driveTurboModeRight = new JoystickButton(driverRightStick, 1);
        driveTurboModeRight.whileHeld(new DriveTrainToggleTurbo());
        driverLeftStick = new Joystick(0);
        
        driveTurboModeLeft = new JoystickButton(driverLeftStick, 1);
        driveTurboModeLeft.whileHeld(new DriveTrainToggleTurbo());
