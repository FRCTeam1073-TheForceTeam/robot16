...
public class Laucher extends Subsystem implements PIDSubsystem {
    ...
    private final Solenoid laucherLockLaucher = RobotMap.laucherlockLaucher;
    ...
    public Laucher() {
//    	openClam();							// Can't do this here. Leaving as a comment so we remember to do it somewhere.
