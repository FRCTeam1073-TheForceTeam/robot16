...
public class RobotMap {
    ...
    public static void init() {
        ...
        driveTrainleftMotor1 = new Victor(0);
        LiveWindow.addActuator("DriveTrain", "leftMotor1", (Victor) driveTrainleftMotor1);
        
        driveTrainleftMotor2 = new Victor(1);
        LiveWindow.addActuator("DriveTrain", "leftMotor2", (Victor) driveTrainleftMotor2);
        
        driveTrainrightMotor1 = new Victor(2);
        LiveWindow.addActuator("DriveTrain", "rightMotor1", (Victor) driveTrainrightMotor1);
        
        driveTrainrightMotor2 = new Victor(3);
        LiveWindow.addActuator("DriveTrain", "rightMotor2", (Victor) driveTrainrightMotor2);
