...
public class RobotMap {
    ...
    public static PowerDistributionPanel dashboardSenderPowerDistributionPanel1;

    // END AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=DECLARATIONS

    public static Encoder laucherlaucherLimitEncoder;
    ...
    public static void init() {
        ...
        dashboardSenderPowerDistributionPanel1 = new PowerDistributionPanel(0);
        LiveWindow.addSensor("DashboardSender", "PowerDistributionPanel 1", dashboardSenderPowerDistributionPanel1);
        

    // END AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=CONSTRUCTORS
        
        laucherlaucherLimitEncoder = new Encoder(11, 12, false, EncodingType.k4X);
        LiveWindow.addSensor("Laucher", "LacuherLimitEncoder", laucherlaucherLimitEncoder);
    }
}
