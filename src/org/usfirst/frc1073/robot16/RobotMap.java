...
public class RobotMap {
    ...
    public static PowerDistributionPanel dashboardSenderpowerDistribution;
    ...
    public static void init() {
        ...
        dashboardSenderpowerDistribution = new PowerDistributionPanel(0);
        LiveWindow.addSensor("DashboardSender", "powerDistribution", dashboardSenderpowerDistribution);
