 ...
 *
 */
public class LauncherToggle extends Command {
    ...
    protected void initialize() {
    	if(Robot.launcherElevation.isLocked()) {
    		...
    		if(Robot.launcherElevation.getAngleDegrees() <= 2 && Robot.launcherElevation.getAngleDegrees() >= 2) {
